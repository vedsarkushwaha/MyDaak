...
<body>
    ...
    <div style="height: 821px; width: 550pt; margin-left: 0px" dir="ltr">
    
        <br />
        <asp:Label ID="Label10" runat="server" Font-Bold="False" Font-Size="X-Large" 
            Font-Underline="True" Text="REGISTRATION FORM"></asp:Label>
        <br />
        <br />
        <br />
        <br />
...
&nbsp;&nbsp;
        ...
        <asp:Label ID="Label14" runat="server" ForeColor="Red" 
            Text="Password Not Matched" Visible="False"></asp:Label>
        <br />
        <br />
        <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <br />
        &nbsp;I had read and understood the terms and condition.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:Label ID="Label13" runat="server" ForeColor="Red" 
            Text="Values of some fields are invalid. Please Check!!!"></asp:Label>
    </div>
    </form>
</body>
</html>
